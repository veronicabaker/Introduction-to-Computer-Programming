...
http://foureyes.github.io/csci-ua.0002-spring2015-007/resources/img/click-circles.gif
...
def handle_click(click_x, click_y):
    ...
    # =====================================
    quadrant_color = get_quadrant_color(click_x, click_y)
